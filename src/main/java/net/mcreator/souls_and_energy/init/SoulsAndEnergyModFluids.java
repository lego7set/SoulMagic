...
import net.mcreator.souls_and_energy.fluid.LiquidManaFluid;
import net.mcreator.souls_and_energy.SoulsAndEnergyMod;

public class SoulsAndEnergyModFluids {
	public static final DeferredRegister<Fluid> REGISTRY = DeferredRegister.create(ForgeRegistries.FLUIDS, SoulsAndEnergyMod.MODID);
