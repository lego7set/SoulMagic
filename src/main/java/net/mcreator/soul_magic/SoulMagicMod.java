 ...
 *
 */
package net.mcreator.soul_magic;
...
@Mod("soul_magic")
public class SoulMagicMod {
	public static final Logger LOGGER = LogManager.getLogger(SoulMagicMod.class);
	public static final String MODID = "soul_magic";
