...
import net.mcreator.soul_magic.world.features.ores.SoulOreFeature;
...
public class SoulMagicModFeatures {
	public static final DeferredRegister<Feature<?>> REGISTRY = DeferredRegister.create(ForgeRegistries.FEATURES, SoulMagicMod.MODID);
